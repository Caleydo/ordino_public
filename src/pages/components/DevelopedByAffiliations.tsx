    ...
    <section className="container ordino-developed-by-affiliations py-6">
      ...
      <div className="row">
        <div className="col position-relative text-center">
          <a href="https://jku.at" target="_blank" rel="noopener noreferrer"><img src={logoJKU} alt="Johannes Kepler University Linz" style={{height: '45px'}} data-testid={`${testId}-jku-link`} /></a>
        </div>
        <div className="col position-relative text-center">
          <a href="https://www.boehringer-ingelheim.com" target="_blank" rel="noopener noreferrer"><img src={logoBI} alt="Boehringer Ingelheim" style={{height: '45px'}} data-testid={`${testId}-boehringer-ingelheim-link`} /></a>
        </div>
        <div className="col position-relative text-center">
          <a href="https://www.datavisyn.io" target="_blank" rel="noopener noreferrer"><img src={logoDatavisyn} alt="datavisyn" style={{height: '35px'}} data-testid={`${testId}-datavisyn-link`} /></a>
        </div>
      </div>
    </section>
  );
