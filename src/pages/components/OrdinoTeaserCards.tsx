        ...
        <div className="col position-relative mb-4" data-testid="new-card">
          ...
          <div className="card shadow-sm h-100">
            <div className="card-body">
              ...
              <p className="card-text">
                The new homepage welcomes new and recurring users and provides an overview of the Ordino <Link to="/features" data-testid="features-link">features</Link>, <Link to="/datasets" data-testid="datasets-link">loaded datasets</Link>, and <Link to="/publications" data-testid="publications-link">publications</Link>.
              </p>
              <p className="card-text">
            ...
            <div className="card-footer">
              <Link to="/news" className="btn btn-light" data-testid="release-notes-link"><i className="me-1 fas fa-angle-right"></i> Read the release notes</Link>
            </div>
          </div>
        </div>
          ...
          <div className="card shadow-sm h-100">
            <div className="card-body">
              ...
              <p className="card-text text-muted">
                ...
                <a href="http://dx.doi.org/10.1093/bioinformatics/btz009" target="_blank" rel="noopener noreferrer" data-testid="paper-link">dx.doi.org/10.1093/bioinformatics/btz009</a>
              </p>
            </div>
            <div className="card-footer">
              <Link to="/publications" className="btn btn-light" data-testid="publications-link"><i className="me-1 fas fa-angle-right"></i> List of all publications</Link>
            </div>
          </div>
        </div>
      </div>
