          ...
          <div className="card shadow-sm h-100">
            <div className="card-body">
              ...
              <p className="card-text">
                The new homepage welcomes new and recurring users and provides an overview of the Ordino <Link to="/features">features</Link>,{' '}
                <Link to="/datasets">loaded datasets</Link>, and <Link to="/publications">publications</Link>.
              </p>
              <p className="card-text">
          ...
          <div className="card shadow-sm h-100">
            <div className="card-body">
              ...
              <p className="card-text text-muted">
                ...
                <a href="http://dx.doi.org/10.1093/bioinformatics/btz009" target="_blank" rel="noopener noreferrer">
