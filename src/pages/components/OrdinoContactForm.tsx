        ...
        <div className="card shadow-sm p-2" data-testid="contactform">
            <div className="card-body">
                <p className="card-text">
                    ...
                    <a className="card-link" href="mailto:ordino@caleydo.org." data-testid="ordino-email">ordino@caleydo.org</a>. We are glad to help you.
                 </p>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        ...
                        <textarea className="form-control" name="message" rows={5} data-testid="message-textarea"></textarea>
                    </div>
