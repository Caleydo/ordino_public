...
export function VideoCard({openInNewWindow, testId: parentTestId}: IVideoCardProps) {
    ...
    return (
        <div style={{overflow: 'hidden'}} className="card p-2 shadow-sm ordino-video-card">
            ...
            <div className="card-body">
                ...
                <iframe className="w-100 pt-2 pb-1" src="https://www.youtube-nocookie.com/embed/JZIIf-k852g?autoplay=0" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture" allowFullScreen></iframe>
            ...
            The list of items together with some basic annotation is then shown in a tabular format.<br />
                ...
                <p className="card-text">
                    You can find more detailed information about the main features <Link {...newWindowProps} className="card-link" to="/features" data-testid={`${testId}-main-features-link`}>here</Link>.
                </p>
                ...
                <p className="card-text">
                    You can find more detailed information about the datasets <Link {...newWindowProps} className="card-link" to="/datasets" data-testid={`${testId}-info-datasets-link`}>here</Link>.
                </p>
                <h5 className="card-title mt-4">
                ...
                <p className="card-text">
                    ...
                    You can find them <Link {...newWindowProps} className="card-link" to="/tours" data-testid={`${testId}-tours-link`}>here</Link>.
                </p>
                <h5 className="card-title mt-4">
                ...
                <p className="card-text">
                    You can find more information about the publications <Link {...newWindowProps} className="card-link" to="/publications" data-testid={`${testId}-publications-link`}>here</Link>.</p>
            </div>
        </div>
    );
}
