    ...
    <div style={{ overflow: 'hidden' }} className="card p-2 shadow-sm ordino-video-card" data-testid="video-card">
      <div className="card-body">
        <p className="card-text lead">
          ...
          set of experimental and metadata. Ordino contains a large set of cancer genomics data allowing to readily address a multitude of use cases as, for
          instance, identifying genes that could serve as potential drug targets or biomarkers, or finding the most appropriate cell line for an experiment.
        </p>
        <iframe
        ...
        <p className="card-text">
          The user starts the analysis by defining a set of genes, cell lines, or tissue samples to work with. The set of items can be determined by manually
          entering a list of identifiers (e.g., a list of gene symbols), by selecting a previously saved or predefined list of items, or by uploading a
          comma-separated file. The list of items together with some basic annotation is then shown in a tabular format.
          <br />
        </p>
        ...
        <ul>
          ...
          <li>Dynamically computed scores, such as the average gene expression of tissue samples from a specific tumor type</li>
          <li>Uploaded custom data attributes</li>
        </ul>
        <p className="card-text">All this data can then be used to interactivaly rank, filter, and explore the items.</p>
        <p className="card-text">
        ...
        <ul>
          <li>Specialized visualizations (e.g., a co-expression plot for comparing multiple genes, an expression vs. copy number plot, or an OncoPrint) </li>
          <li>Another ranked table (e.g., a list of all cell lines plus their gene expression for the selected genes)</li>
          <li>Embedded external resources (e.g., Ensembl and Open Targets)</li>
        </ul>
        <p className="card-text">
        ...
        <p className="card-text">
          ...
          <br /> and The Cancer Genome Atlas (TCGA). Furthermore, two CRISPR / RNAi loss-of-function screen data sets (DRIVE and Avana) are included.
        </p>
        ...
        <h5 className="card-title mt-4">
          <i className="me-2 fas fa-mouse-pointer" />
          Tours
        </h5>
        <p className="card-text">
        ...
        <p className="card-text">Ordino and its components have been described in the following scientific publications.</p>
