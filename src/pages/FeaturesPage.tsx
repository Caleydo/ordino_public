        ...
        <div className="ordino-container">
          <div className="p-6 container">
            ...
            <div className="row">
              <div className="col">
                <p className="lead text-gray-600">
                  A core component of the Ordino system is the interactive visualization technique <a href="http://lineup.js.org" target="_blank" rel="noopener noreferrer" data-testid={`${testId}-lineup-link`}>LineUp</a>,
            ...
            currently selected items with the ranking visualization technique <a href="http://lineup.js.org" target="_blank" rel="noopener noreferrer" data-testid={`${testId}-feature-card-lineup-link`}>LineUp</a>.</p>
              </FeatureCard>
            ...
            can look at the information available on <a href="https://ensembl.org/" target="_blank" rel="noopener noreferrer" data-testid={`${testId}-feature-card-ensembl-link`}>Ensembl</a>, <a href="https://proteinatlas.org/" target="_blank" rel="noopener noreferrer" data-testid={`${testId}-feature-card-proteinatlas-link`}>Human Protein Atlas</a>, <a href="https://www.targetvalidation.org/" target="_blank" rel="noopener noreferrer" data-testid={`${testId}-feature-card-targets-link`}>Open Targets</a>, <a href="https://www.ncbi.nlm.nih.gov/pubmed" target="_blank" rel="noopener noreferrer" data-testid={`${testId}-feature-card-pubmed-link`}>PubMed</a>, and <a href="https://www.ncbi.nlm.nih.gov/pubmed" target="_blank" rel="noopener noreferrer" data-testid={`${testId}-feature-card-uniprot-link`}>UniProt</a>.
            For cell lines, the analyst can load the information available on <a href="https://cancer.sanger.ac.uk/cosmic/" target="_blank" rel="noopener noreferrer" data-testid={`${testId}-feature-card-cosmic-link`}>COSMIC</a> (Catalogue Of Somatic Mutations In Cancer).</p>
              </FeatureCard>
            </div>
          </div>
