  ...
  },
  {
    ...
    markup: () => (
      <>
        ...
        <img className=" img-fluid border border-gray-800" src={v800_gene_signature} alt="Gene Signature Score" />
        ...
        <img className="img-fluid border border-gray-800" src={v800_annotation_column} alt="Annotation Column" />
        ...
        <img className="img-fluid border border-gray-800" src={v800_data_download} alt="Download Data" />
      </>
    )
  },
  {
