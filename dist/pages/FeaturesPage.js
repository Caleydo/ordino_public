        ...
        React.createElement("div", { className: "position-relative pt-6" },
            React.createElement("div", { className: "ordino-container" },
                React.createElement("div", { className: "p-6 container" },
                    ...
                    React.createElement("div", { className: "row" },
                        React.createElement("div", { className: "col" },
                            React.createElement("p", { className: "lead text-gray-500" }, "The user starts the analysis by defining a set of items. The item set can be determined by manually entering a list of identifiers (e.g., a list of gene symbols), by selecting a previously saved or predefined list of items, or by uploading a comma-separated file."))),
                    ...
                    React.createElement("div", { className: "row" },
                        React.createElement("div", { className: "col" },
                            React.createElement("p", { className: "lead text-gray-500" },
                    ...
                    React.createElement("div", { className: "row" },
                        React.createElement("div", { className: "col" },
                            React.createElement("p", { className: "lead text-gray-500" }, "Users can select one or more items in a ranking table for exploration using a collection of detail views. The detail views offered to the user depend on the type of items selected. Ordino includes the following detail views:"))),
                    React.createElement("div", { className: "row row-cols-md-2" },
