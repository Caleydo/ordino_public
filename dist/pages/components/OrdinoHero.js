...
export function OrdinoHero() {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "ordino-hero" },
            ...
            React.createElement("div", { className: "container", "data-testid": "ordino-hero" },
                ...
                React.createElement("div", { className: "row ordino-hero-actions my-4" },
                    React.createElement("div", { className: "col text-center" },
                        React.createElement("button", { type: "button", className: "btn btn-link btn-lg", "data-testid": "play-button", onClick: () => setModalIsClosed(false), "data-bs-toggle": "modal", "data-bs-target": `#${INTRO_VIDEO_MODAL_ID}` },
                            React.createElement("i", { className: "fas fa-play" }),
                            "Watch intro video")),
                    React.createElement("div", { className: "col text-center" },
                        React.createElement(Link, { to: "/help", className: "btn btn-link btn-lg", "data-testid": "info-link" },
        ...
        React.createElement("div", { className: "modal", id: INTRO_VIDEO_MODAL_ID, "data-testid": "ordino-intro-video-modal", onClick: handleCloseModal, "aria-labelledby": "ordino-intro-video-modal-title", "aria-hidden": "true" },
            React.createElement("div", { className: "modal-dialog ordino-intro-video-modal" },
                React.createElement("div", { className: "modal-content" },
                    React.createElement("div", { className: "modal-header" },
                        ...
                        React.createElement("button", { type: "button", className: "btn-close", "data-testid": "close-button", onClick: () => setModalIsClosed(true), "data-bs-dismiss": "modal", "aria-label": "Close" })),
