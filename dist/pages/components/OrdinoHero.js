...
export function OrdinoHero({ testId: parentTestId }) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "ordino-hero" },
            React.createElement(HeaderNavigation, { bg: "transparent", testId: testId }),
            React.createElement("div", { className: "container" },
                ...
                React.createElement("div", { className: "row ordino-hero-actions my-4" },
                    React.createElement("div", { className: "col text-center" },
                        React.createElement("button", { type: "button", className: "btn btn-link btn-lg", onClick: () => setModalIsClosed(false), "data-bs-toggle": "modal", "data-bs-target": `#${INTRO_VIDEO_MODAL_ID}`, "data-testid": `${testId}-play-button` },
                            React.createElement("i", { className: "fas fa-play" }),
                            "Watch intro video")),
                    React.createElement("div", { className: "col text-center" },
                        React.createElement(Link, { to: "/help", className: "btn btn-link btn-lg", "data-testid": `${testId}-info-link` },
            ...
            React.createElement("div", { className: "modal-dialog ordino-intro-video-modal" },
                React.createElement("div", { className: "modal-content" },
                    React.createElement("div", { className: "modal-header" },
                        ...
                        React.createElement("button", { type: "button", className: "btn-close", onClick: () => setModalIsClosed(true), "data-bs-dismiss": "modal", "aria-label": "Close", "data-testid": `${testId}-close-video-button` })),
