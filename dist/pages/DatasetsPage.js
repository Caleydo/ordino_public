                    ...
                    React.createElement("div", { className: "row row-cols-md-2 row-cols-1" },
                        React.createElement("div", { className: "col" },
                            React.createElement(DatasetPageCard, { title: "Cancer Cell Line Encyclopedia (CCLE)" },
                                ...
                                React.createElement("a", { className: "card-link", href: "https://portals.broadinstitute.org/ccle", "data-testid": "ccle-link", target: "_blank", rel: "noopener" }, "portals.broadinstitute.org/ccle"))),
                        React.createElement("div", { className: "col" },
                            React.createElement(DatasetPageCard, { title: "The Cancer Genome Atlas (TCGA)" },
                                React.createElement("p", { className: "card-text" }, "Sample annotation, gene expression, mutation, and copy number data "),
                                React.createElement("a", { className: "card-link", href: "https://cancergenome.nih.gov", "data-testid": "tcga-link", target: "_blank", rel: "noopener" }, "cancergenome.nih.gov")))),
                    ...
                    React.createElement("div", { className: "row row-cols-md-2 row-cols-1" },
                        React.createElement("div", { className: "col" },
                            React.createElement(DatasetPageCard, { title: "Project DRIVE" },
                                ...
                                React.createElement("a", { className: "card-link", href: "https://doi.org/10.1016/j.cell.2017.07.005", "data-testid": "drive-link", target: "_blank", rel: "noopener" }, " McDonald III, E. R. et. al. Project DRIVE: A Compen- dium of Cancer Dependencies and Synthetic Lethal Relationships Uncovered by Large-Scale, Deep RNAi Screening. Cell 170, Pages 577-592.e10 (2017)."))),
                        React.createElement("div", { className: "col" },
