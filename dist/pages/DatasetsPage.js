                    ...
                    React.createElement("div", { className: "row row-cols-md-2 row-cols-1" },
                        React.createElement("div", { className: "col" },
                            React.createElement(DatasetPageCard, { title: "Cancer Cell Line Encyclopedia (CCLE)" },
                                ...
                                React.createElement("a", { className: "card-link", href: "https://portals.broadinstitute.org/ccle", target: "_blank", rel: "noopener noreferrer" }, "portals.broadinstitute.org/ccle"))),
                        React.createElement("div", { className: "col" },
                            React.createElement(DatasetPageCard, { title: "The Cancer Genome Atlas (TCGA)" },
                                React.createElement("p", { className: "card-text" }, "Sample annotation, gene expression, mutation, and copy number data "),
                                React.createElement("a", { className: "card-link", href: "https://cancergenome.nih.gov", target: "_blank", rel: "noopener noreferrer" }, "cancergenome.nih.gov")))),
                    ...
                    React.createElement("div", { className: "row row-cols-md-2 row-cols-1" },
                        ...
                        React.createElement("div", { className: "col" },
                            React.createElement(DatasetPageCard, { title: "Avana CERES" },
                                ...
                                React.createElement("a", { className: "card-link", href: "https://doi.org/10.1038/ng.3984", target: "_blank", rel: "noopener noreferrer" }, "Meyers, R. M. et. al. Computational correction of copy number effect improves specificity of CRISPR\u2013Cas9 essentiality screens in cancer cells. Nature Genetics 49, 1779\u20131784 (2017)."))))),
