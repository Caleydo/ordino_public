...
export function TermsOfUseCard({ openInNewWindow = false }) {
        ...
        React.createElement("div", { className: "card-body" },
            React.createElement("div", { className: "list-group list-group-flush" },
                ...
                React.createElement("div", { className: "list-group-item" },
                    ...
                    "Please see the",
                    ' ',
                    openInNewWindow ? (React.createElement(Link, { to: "/publications", target: "_blank", rel: "noopener noreferrer" }, "Publications page")) : (React.createElement(Link, { to: "/publications" }, "Publications page")),
                    ' ',
